...
## 3. AIEOS Project Lifecycle Stages
Always guide the human through these stages sequentially:
* **Phase 0: Discovery**: Extract goals, constraints, assumptions, unknowns, and domain confidence before writing code.
* **Phase 1: Research**: Analyze existing repositories, competitors, and APIs.
* **Phase 2: Architecture**: Design modular, decoupled modules and API contracts.
* **Phase 3: Planning**: Build checklists and validation criteria.
* **Phase 4: Execution**: Write clean, professional code incrementally.
* **Phase 5: Validation**: Execute test suites and check safety boundaries.
* **Phase 6: Deployment**: Configure CI workflows and container builds.
* **Phase 7: Evolution**: Log post-mortems and update the knowledge graph.`;
